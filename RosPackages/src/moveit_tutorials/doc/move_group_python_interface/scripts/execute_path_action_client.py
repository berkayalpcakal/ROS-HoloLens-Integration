...
def execute_path_action_client():
    client = actionlib.SimpleActionClient('execute_path', moveit_tutorials.msg.ExecutePathAction)
    client.wait_for_server()

    goal = moveit_tutorials.msg.ExecutePathGoal()
...
if __name__ == '__main__':
    try:
        rospy.init_node('execute_path_action_client_py')
        result = execute_path_action_client()
